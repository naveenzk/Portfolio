    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="px-5 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white text-sm font-semibold hover:from-purple-500 hover:to-fuchsia-500 transition-all duration-200 glow-sm hover:scale-105"
          >
            Hire Me
          </a>
        </div>
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden glass border-t border-purple-900/30"
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              ...
              <a
                href="#contact"
                className="px-5 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white text-sm font-semibold text-center"
                onClick={() => setMenuOpen(false)}
              >
                Hire Me
              </a>
