    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-slate-400 text-lg md:text-xl leading-relaxed mb-8 max-w-2xl lg:max-w-none">
            I'm a Software Developer passionate about backend systems, AI-driven automation, and
            building scalable SaaS applications that solve real-world problems. I turn complex
            challenges into elegant, production-ready solutions.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 justify-center lg:justify-start mb-10">
            ...
            <a
              href="#contact"
              className="px-7 py-3 rounded-xl text-slate-300 font-semibold hover:text-white transition-colors flex items-center gap-2 border border-slate-700 hover:border-slate-500"
            >
              <Mail size={16} />
              Contact Me
            </a>
